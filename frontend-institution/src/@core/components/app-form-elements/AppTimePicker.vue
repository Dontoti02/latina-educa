...
const config = ref({
  wrap: true, 
  altFormat: 'h:i K',  // Formato solo hora
  altInput: true,  // Puedes mantenerlo si quieres que tenga una apariencia más estilizada
  dateFormat: 'H:i', // Formato solo hora (24 horas)
  enableTime: true,  // Habilita la selección de hora
  noCalendar: true,  // Desactiva la selección de fecha
  locale: Spanish, 
});
