...
import { Capacitation, CapacitationContentItem } from '@/models/capacitations';
import { DateFormatting } from '@/utils/date-formatting';

// Initial
const props = withDefaults(defineProps<{
  contentGroupId: number
  contentItem: CapacitationContentItem
...
const session =  {
  isTeacher: () => props.capacitation.is_teacher,
  isStudent: () => props.capacitation.is_student,  
}
