...
import { CapacitationStudentScoresService } from '@/services/capacitation-student-scores.service'
...
const getStudentEvaluations = () => {
  loading.value = true
  CapacitationStudentScoresService.getStudentScoresForTeacher(props.classroomId, props.student.person_id)
    .then(response => {
