...
import { FormQuestion, QuestionType } from "../../models/evalution-form";
...
const emit = defineEmits<{
  (e: "change", data: FormQuestion): void;
  (e: "delete", data: FormQuestion): void;
}>();

// Variables
const inputTypeKey = ref<string>(props.question.question_type_key);
...
const changeInputType = () => {
  emit("change", {
    ...props.question,
    question_type_key: inputTypeKey.value,
  });
};
...
watch(
  ...
  (newValue) => {
    if (newValue && !inputTypeKey.value) {
      inputTypeKey.value = props.question.question_type_key;
    }
  },
