...
import type { Services } from '@/models/landing'
...
<template>
  <VContainer class="px-md-16">
    <VCard
      elevation="0"
      color="#ffffff00"
    >
      <div class="d-flex justify-center align-center flex-column mb-12 px-md-0 px-10">
        <VChip
          label
          color="primary"
          class="mb-4"
      ...
      >
        <VCardText style="max-width: 90rem;">
          <VRow>
            <VCol
              v-for="(service, index) in services.arrServices"
              :key="`service-${index}`"
              cols="12"
              sm="6"
              md="4"
